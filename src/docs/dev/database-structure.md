...
O Firestore exige que os caminhos para documentos sempre tenham um número par de segmentos. Isso significa que a estrutura deve seguir o padrão:

`coleção/{documentoId}/coleção/{documentoId}/...`

**Exemplo Correto:**
`Global/master/config/modules_config` (4 segmentos)

**Exemplo Incorreto:**
`Global/master/ai_module_data` (3 segmentos) - Isso resultaria em um erro.
