...
-   **Botão de Voltar (`<BackButton />`):** Para manter um design limpo e não interferir com o título, o botão "Voltar" deve ser posicionado de forma absoluta no **canto superior direito** do cabeçalho.
