// src/app/[locale]/(app)/companies/edit/page.tsx
"use client";
...
// This is now the single, master component for editing a company.
export default function EditCompanyMasterPage() {
    ...
    if (!hasPermission('master.companies.edit')) {
        return <AccessDenied />;
    }
